...
const ListingDetails = () => {
  ...
  // // get data of an object detail with its id
  // listing with some field defined in IListingType
  // listingData data with some type defined
  const listing: IListingType = (listingData as IListingType[]).find(
    (item) => item.id === id
  );
